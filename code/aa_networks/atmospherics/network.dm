var/global/list/datum/network/atmos/pipe_networks = list()
/datum/network/atmos
	...
	build_network(var/obj/machinery/networked/atmos/start_normal, var/obj/machinery/networked/atmos/reference)
	...
	proc/update_network_gases()
		...
		for(var/obj/machinery/networked/atmos/normal_member in normal_members)
			var/result = normal_member.return_network_air(src)
			if(result) gases += result

		for(var/datum/physical_network/atmos/physnet in physical_networks)
			gases += physnet.air
