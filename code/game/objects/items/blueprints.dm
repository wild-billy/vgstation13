...
/obj/item/blueprints/proc/set_area_machinery_title(var/area/A,var/title,var/oldtitle)
	...
	for(var/area/RA in A.related)
		...
		for(var/obj/machinery/networked/power/apc/M in RA)
			M.name = replacetext(M.name,oldtitle,title)
		for(var/obj/machinery/networked/atmos/unary/vent_scrubber/M in RA)
			M.name = replacetext(M.name,oldtitle,title)
		for(var/obj/machinery/networked/atmos/unary/vent_pump/M in RA)
			M.name = replacetext(M.name,oldtitle,title)
