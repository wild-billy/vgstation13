...
/obj/effect/spider/spiderling
	...
	health = 3
	var/amount_grown = 0
	var/obj/machinery/networked/atmos/unary/vent_pump/entry_vent
...
/obj/effect/spider/spiderling/process()
	if(travelling_in_vent)
		...
		if(get_dist(src, entry_vent) <= 1)
			if(entry_vent.network && entry_vent.network.normal_members.len)
				var/list/vents = list()
				for(var/obj/machinery/networked/atmos/unary/vent_pump/temp_vent in entry_vent.network.normal_members)
					vents.Add(temp_vent)
				if(!vents.len)
					entry_vent = null
					return
				var/obj/machinery/networked/atmos/unary/vent_pump/exit_vent = pick(vents)
				/*if(prob(50))
	...
	//=================
		...
		//ventcrawl!
		for(var/obj/machinery/networked/atmos/unary/vent_pump/v in view(7,src))
			if(!v.welded)
				entry_vent = v
