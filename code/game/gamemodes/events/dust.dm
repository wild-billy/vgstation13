	...
	Bump(atom/A)
		spawn(0)
			...
			if (A)
				...
				else if(!istype(A,/obj/machinery/networked/power/emitter) && !istype(A,/obj/machinery/field_generator)) //Protect the singularity from getting released every round!
