/obj/machinery/portable_atmospherics
	...
	var/obj/machinery/networked/atmos/portables_connector/connected_port
	...
	initialize()
		. = ..()
		spawn()
			var/obj/machinery/networked/atmos/portables_connector/port = locate() in loc
			if(port)
				connect(port)
				update_icon()
	...
	proc
		...
		connect(obj/machinery/networked/atmos/portables_connector/new_port)
